...
query = "What is the check-in time for the hotel in Tokyo?"

# 5. Setup the Retriever (Note: search_type fix)
retriever = db.as_retriever(
    search_type="similarity_score_threshold", # Corrected name
    search_kwargs={"k": 3, "score_threshold": 0.2} # Lowered threshold slightly for better testing
)
